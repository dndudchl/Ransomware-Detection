#!/usr/bin/env python3
"""
search_github_installers.py - Find Windows installers by searching GitHub,
rather than by naming projects from memory.

Why search rather than a list
-----------------------------
The hand-written list in fetch_github_installers.py runs out. Of 109 projects
...
-----
  export GITHUB_TOKEN=...
  python3 search_github_installers.py --out-list ~/work/repos_found.txt
  python3 search_github_installers.py --out-list ~/work/repos_found.txt \\
...
def main():
    ...
    print("\nFeed the list to fetch_github_installers.py:")
    print("   python3 fetch_github_installers.py --only-extra --max-mb 250 \\")
